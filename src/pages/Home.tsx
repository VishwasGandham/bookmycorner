  ...
  return (
    <>
      <SEO
        ...
        description="Browse verified residential & commercial plots. Direct owner contacts, transparent pricing."
      />
      <Hero />
      ...
      {cornerPlots.length > 0 && (
        <Section
          icon={<CornerDownRight className="h-6 w-6" />}
          title="Corner Plots"
